        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h1 class="section-title text-center">Get Involved</h1>
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="mt-4 pt-4">
                        <p class="mt-4"><span class="h5"><label for="username">First Name: </label>
                        ...
                        <p class="mt-4"><span class="h5"><label for="password">Password: </label>
                                ...
                                class="text-muted d-block mt-2"><br /></span></p>
                        <p class="mt-4"><span class="h5">Email Address:</span><br> <span
                                class="text-muted d-block mt-2"></span></p>
                    </div></form>
                </div>
                <div class="col-lg-8">
