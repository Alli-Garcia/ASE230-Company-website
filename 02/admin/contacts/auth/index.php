...
<body data-bs-theme="light">
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-white navbar-custom sticky sticky-white" role="navigation"
        ...
        <div class="container">
            ...
            <ul class="navbar-nav navbar-center" id="navbar-navlist">
                ...
                <li class="nav-item">
                    <a href="../awards/index.php" class="nav-link">Awards</a>
                </li>
                <li class="nav-item">
                    <a href="../homes/index.php" class="nav-link">Listings</a>
                </li>
                <li class="nav-item">
                    <a  href="../team/index.php" class="nav-link">Teams</a>
                </li>
                <li class="nav-item">
                    <a  href="../contacts/index.php" class="nav-link">Contact</a>
                </li>
                <li class="nav-item">
    ...
    <!--START HOME-->
    <section class="section bg-home home-half" id="home" data-image-src="../02/images/bg-home.jpg">
